...
export default class Client {
  ...
  static async httpsCfg(siteResponseBody: $ESA20240910.CreateSiteResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateHttpsBasicConfigurationResponseBody> {
  ...
  static async updateHttpsCfg(siteResponseBody: $ESA20240910.CreateSiteResponseBody, createHttpsBasicConfigurationResponseBody: $ESA20240910.CreateHttpsBasicConfigurationResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async destroyHttpsCfg(siteResponseBody: $ESA20240910.CreateSiteResponseBody, createHttpsBasicConfigurationResponseBody: $ESA20240910.CreateHttpsBasicConfigurationResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    // update resource
    await Client.updateHttpsCfg(siteRespBody, httpsCfgRespBody, esa20240910Client);
    // destroy resource
    await Client.destroyHttpsCfg(siteRespBody, httpsCfgRespBody, esa20240910Client);
  }
