...
export default class Client {
  ...
  static async ratePlanInstCaa(client: ESA20240910): Promise<$ESA20240910.PurchaseRatePlanResponseBody> {
  ...
  static async siteCaa(ratePlanInstCaaResponseBody: $ESA20240910.PurchaseRatePlanResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateSiteResponseBody> {
  ...
  static async record(siteCaaResponseBody: $ESA20240910.CreateSiteResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateRecordResponseBody> {
  ...
  static async updateRecord(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async destroyRecord(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    // Init resource
    let ratePlanInstCaaRespBody = await Client.ratePlanInstCaa(esa20240910Client);
    let siteCaaRespBody = await Client.siteCaa(ratePlanInstCaaRespBody, esa20240910Client);
    let recordRespBody = await Client.record(siteCaaRespBody, esa20240910Client);
    // update resource
    await Client.updateRecord(recordRespBody, esa20240910Client);
    // destroy resource
    await Client.destroyRecord(recordRespBody, esa20240910Client);
  }
