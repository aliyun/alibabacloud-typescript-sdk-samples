...
export default class Client {
  ...
  static async ratePlanInstSshfp(client: ESA20240910): Promise<$ESA20240910.PurchaseRatePlanResponseBody> {
  ...
  static async siteSshfp(ratePlanInstSshfpResponseBody: $ESA20240910.PurchaseRatePlanResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateSiteResponseBody> {
  ...
  static async recordSshfp(siteSshfpResponseBody: $ESA20240910.CreateSiteResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateRecordResponseBody> {
  ...
  static async updateRecordSshfp(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async destroyRecordSshfp(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    // Init resource
    let ratePlanInstSshfpRespBody = await Client.ratePlanInstSshfp(esa20240910Client);
    let siteSshfpRespBody = await Client.siteSshfp(ratePlanInstSshfpRespBody, esa20240910Client);
    let recordSshfpRespBody = await Client.recordSshfp(siteSshfpRespBody, esa20240910Client);
    // update resource
    await Client.updateRecordSshfp(recordSshfpRespBody, esa20240910Client);
    // destroy resource
    await Client.destroyRecordSshfp(recordSshfpRespBody, esa20240910Client);
  }
