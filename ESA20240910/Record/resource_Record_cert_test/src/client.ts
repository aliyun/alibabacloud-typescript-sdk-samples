...
export default class Client {
  ...
  static async ratePlanInstCert(client: ESA20240910): Promise<$ESA20240910.PurchaseRatePlanResponseBody> {
  ...
  static async siteCert(ratePlanInstCertResponseBody: $ESA20240910.PurchaseRatePlanResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateSiteResponseBody> {
  ...
  static async recordCert(siteCertResponseBody: $ESA20240910.CreateSiteResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateRecordResponseBody> {
  ...
  static async updateRecordCert(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async destroyRecordCert(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    // Init resource
    let ratePlanInstCertRespBody = await Client.ratePlanInstCert(esa20240910Client);
    let siteCertRespBody = await Client.siteCert(ratePlanInstCertRespBody, esa20240910Client);
    let recordCertRespBody = await Client.recordCert(siteCertRespBody, esa20240910Client);
    // update resource
    await Client.updateRecordCert(recordCertRespBody, esa20240910Client);
    // destroy resource
    await Client.destroyRecordCert(recordCertRespBody, esa20240910Client);
  }
