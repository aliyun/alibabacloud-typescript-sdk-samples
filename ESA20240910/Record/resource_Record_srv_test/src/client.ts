...
export default class Client {
  ...
  static async record(siteResponseBody: $ESA20240910.CreateSiteResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateRecordResponseBody> {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let recordRespBody = await Client.record(siteRespBody, esa20240910Client);
    // update resource
