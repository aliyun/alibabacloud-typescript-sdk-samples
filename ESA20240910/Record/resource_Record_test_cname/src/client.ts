...
export default class Client {
  ...
  static async recordCname(siteResponseBody: $ESA20240910.CreateSiteResponseBody, client: ESA20240910): Promise<$ESA20240910.CreateRecordResponseBody> {
    console.info("Begin Call CreateRecord to create resource");
    let authConf = new $ESA20240910.CreateRecordRequestAuthConf({
  ...
  static async updateRecordCname(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
    console.info("Begin Call UpdateRecord to update resource");
    let authConf = new $ESA20240910.UpdateRecordRequestAuthConf({
  ...
  static async destroyRecordCname(createRecordResponseBody: $ESA20240910.CreateRecordResponseBody, client: ESA20240910): Promise<void> {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let recordCnameRespBody = await Client.recordCname(siteRespBody, esa20240910Client);
    // update resource
    await Client.updateRecordCname(recordCnameRespBody, esa20240910Client);
    // destroy resource
    await Client.destroyRecordCname(recordCnameRespBody, esa20240910Client);
  }
